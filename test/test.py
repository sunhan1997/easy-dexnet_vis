...
HDF5_FILE = r'/home/sunh/6D_grasp/easy-dexnet/template/test.hdf5'
...
def test_dataset():
    ...
    ff = h5py.File(r'/home/sunh/6D_grasp/easy-dexnet/template/test.hdf5', 'a')
    dex_obj = dex.DexObject.from_file(TEST_OBJ_FILE, config)
...
def test_to_hdf5():
    ...
    f = h5py.File(r'/home/sunh/6D_grasp/easy-dexnet/template/test.hdf5', 'a')
    dex_obj = dex.DexObject.from_file(TEST_OBJ_FILE, config)
